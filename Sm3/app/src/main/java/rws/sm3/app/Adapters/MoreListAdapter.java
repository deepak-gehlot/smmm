...
/**
 * Created by Android-2 on 10/26/2015.
 */
public class MoreListAdapter extends BaseAdapter {
    Context appContext;
    ArrayList<JSONObject> jsonObjects;

    public MoreListAdapter(Context appContext, LinkedList<JSONObject> jsonArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = li.inflate(R.layout.single_contentlist, null);
