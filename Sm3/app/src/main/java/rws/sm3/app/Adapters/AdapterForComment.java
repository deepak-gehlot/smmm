...
public class AdapterForComment extends BaseAdapter {
    ...
    public AdapterForComment(Context appContext, ArrayList<JSONObject> jsonArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            viewHolder.auth_name.setVisibility(View.VISIBLE);
            viewHolder.auth_name.setText(j.getString("comment_description"));
